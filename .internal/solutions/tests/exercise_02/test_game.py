import pytest
from connect_four_solutions.exercise_02.domain import events, exceptions, game
...
def test_player_can_make_a_move() -> None:
    ...
    # WHEN that player places a token in a column
    game_obj.make_move(player=game_obj.next_player, column=game.enums.Column.A)
